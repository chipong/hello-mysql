...
type Friend struct {
	Friend string      `boil:"friend" json:"friend" toml:"friend" yaml:"friend"`
...
var FriendWhere = struct {
	Friend whereHelperstring
	Name   whereHelpernull_String
}{
	Friend: whereHelperstring{field: "`friend`.`friend`"},
	Name:   whereHelpernull_String{field: "`friend`.`name`"},
}
...
var (
	friendAllColumns            = []string{"friend", "name"}
	friendColumnsWithoutDefault = []string{"friend", "name"}
	friendColumnsWithDefault    = []string{}
	friendPrimaryKeyColumns     = []string{"friend"}
...
func (q friendQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Friend, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for friend")
	}
...
func (q friendQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count friend rows")
	}
...
func (q friendQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if friend exists")
	}
...
func Friends(mods ...qm.QueryMod) friendQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`friend`.*"})
	}
...
func FindFriend(ctx context.Context, exec boil.ContextExecutor, friend string, selectCols ...string) (*Friend, error) {
	friendObj := &Friend{}
	...
	query := fmt.Sprintf(
		"select %s from `friend` where `friend`=?", sel,
	)

	q := queries.Raw(query, friend)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from friend")
	}
...
func (o *Friend) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no friend provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into friend")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for friend")
	}
...
func (o *Friend) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update friend, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update friend row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for friend")
	}
...
func (q friendQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for friend")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for friend")
	}
...
func (o *Friend) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no friend provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("models: unable to upsert friend, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for friend")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for friend")
	}
...
func (o *Friend) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM `friend` WHERE `friend`=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from friend")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for friend")
	}
...
func (q friendQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from friend")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for friend")
	}
...
func (o *Friend) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindFriend(ctx, exec, o.Friend)
	if err != nil {
		return err
	}
...
func FriendExists(ctx context.Context, exec boil.ContextExecutor, friend string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `friend` where `friend`=? limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, friend)
	}
	row := exec.QueryRowContext(ctx, sql, friend)

	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if friend exists")
	}
...
func (o *Friend) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return FriendExists(ctx, exec, o.Friend)
}
